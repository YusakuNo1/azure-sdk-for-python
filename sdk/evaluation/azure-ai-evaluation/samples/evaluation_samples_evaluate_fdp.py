...
class EvaluationEvaluateSamples(object):
    def evaluation_evaluate_classes_methods(self):
        ...
        # path = "/Users/weiwu/Workspaces/Microsoft/azure-sdk-for-python/sdk/evaluation/azure-ai-evaluation/samples/sample_synthetic_conversations.jsonl"
        ...
        import json
        with open("1_run_evaluate_for_intent_resolution.json", "w") as outfile:
        ...
        with open(path, "r") as f:
            ...
            for line in data:
                ...
                # append all the fields from row to result, insert in front of all the fields in result
                for key in row:
                    result = {key: row[key], **result}
                results.append(result)
            import json
            with open("2_run_intent_resolution.json", "w") as outfile:
